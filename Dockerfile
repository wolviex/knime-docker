...
ARG PRODUCT_VERSION=${PRODUCT_VERSION:-latest52}
...
# ENV DOWNLOAD_URL=https://download.knime.org/analytics-platform/linux/knime-latest52-linux.gtk.x86_64.tar.gz
ENV DOWNLOAD_URL=https://download.knime.org/analytics-platform/linux/${PRODUCT}-${PRODUCT_VERSION}-linux.gtk.x86_64.tar.gz
